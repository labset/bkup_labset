...
class CreateCoreTenantTable implements IDynamoDbMigration {
    readonly TableName: string;
    constructor() {
        this.TableName = tableNames.core.tenant;
    }
    ...
    async up(client: DynamoDBClient): Promise<void> {
        const params = {
            ...
            AttributeDefinitions: [
                ...
                { AttributeName: 'domainName', AttributeType: 'S' }
            ],
            KeySchema: [
            ...
            LocalSecondaryIndexes: [
                {
                    IndexName: 'tenantDomainIndex',
                    KeySchema: [
                        { AttributeName: 'part', KeyType: 'HASH' },
                        { AttributeName: 'domainName', KeyType: 'RANGE' }
                    ],
                    Projection: {
                        ProjectionType: 'ALL'
                    }
...
const createCoreTenantTable = new CreateCoreTenantTable();

export { createCoreTenantTable };
