...
class CreatePublisherContentTable implements IDynamoDbMigration {
    readonly TableName: string;
    constructor() {
        this.TableName = tableNames.publisher.content;
    }
...
const createMPSApplicationTable = new CreatePublisherContentTable();

export { createMPSApplicationTable };
