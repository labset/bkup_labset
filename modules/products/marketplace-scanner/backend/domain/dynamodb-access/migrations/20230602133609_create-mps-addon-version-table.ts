...
class CreateMPSAddonVersionTable implements IDynamoDbMigration {
    readonly TableName: string;
    constructor() {
        this.TableName = tableNames.mps.addonVersion;
    }
...
const createMPSAddonVersionTable = new CreateMPSAddonVersionTable();

export { createMPSAddonVersionTable };
