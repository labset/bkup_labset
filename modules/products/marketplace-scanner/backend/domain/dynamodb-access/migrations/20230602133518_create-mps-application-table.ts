...
class CreateMPSApplicationTable implements IDynamoDbMigration {
    readonly TableName: string;
    constructor() {
        this.TableName = tableNames.mps.application;
    }
...
const createMPSApplicationTable = new CreateMPSApplicationTable();
